          ...
          <form onSubmit={register}>
            ...
            <div className="my-4 w-full flex items-center gap-2">
              ...
              <p className="text-white">
                By Register, I agree that I'm 18 years of age or older,  to the <Link to="#" className="text-primary">User <br/>  Agreement, Privacy Policy, Cookie Policy</Link>
              </p>
            </div>
            {password === confrimPassword && password !== "" ? (
              ...
              <button className="w-full btn   capitalize btn-disabled" disabled>
               Register
              </button>
            )}
